          ...
          <div className="md:col-span-3 bg-white rounded-3xl shadow-2xl p-8 md:p-12 flex flex-col relative z-10">
            <div className="flex-1 flex flex-col items-center justify-center space-y-8">
              ...
              <div className="w-full max-w-md">
                ...
                <button
                  className="w-full py-3 text-base font-medium flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all duration-200 hover:bg-purple-600 hover:text-white rounded-md cursor-pointer"
